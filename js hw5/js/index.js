...
function createNewUser(){
    let newUser = {
        ...
        getAge: function () {
            ...
            let inputDate = +this.birthday.substring(0, 3);
            let inputMonth = +this.birthday.substring(4, 5);
            let inputYear = +this.birthday.substring(6, 11);
        ...
        getPassword: function () {
            ...
            return console.log(this.firstName[0].toUpperCase() + this.secondName.toLowerCase() + this.birthday.substring(6,11));
        }
    };
